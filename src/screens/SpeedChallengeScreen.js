...
const styles = StyleSheet.create({
  ...
  multText: { color: COLORS.amber, fontSize: scaleFont(11), fontFamily: 'Calibri', fontWeight: '700' },
  multTrack: {
  ...
  nextHint: { color: COLORS.textDim, fontSize: scaleFont(10.5), fontFamily: 'Calibri', fontWeight: '600', marginTop: scaleSize(12), textAlign: 'center' },
  ...
  scoreVal: { color: COLORS.amber, fontSize: scaleFont(22), fontFamily: 'Calibri', fontWeight: '700' },
