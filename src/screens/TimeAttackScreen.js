...
const styles = StyleSheet.create({
  ...
  clockText: { color: COLORS.textWhite, fontSize: scaleFont(14), fontFamily: 'Poppins_700Bold', fontWeight: '700' },

  clockStage: { alignItems: 'center', marginBottom: scaleSize(12) },
  clockBig: {
    color: COLORS.cyan, fontSize: scaleFont(46), fontFamily: 'Poppins_700Bold', fontWeight: '700',
  ...
  clockLabel: { color: COLORS.textMuted, fontSize: scaleFont(11), fontFamily: 'Poppins_700Bold', fontWeight: '700', letterSpacing: 1, marginBottom: scaleSize(8) },
  clockTrack: {
  ...
  plainLetter: {
    fontSize: scaleFont(18), fontFamily: 'Poppins_700Bold', fontWeight: '700', color: COLORS.textWhite,
