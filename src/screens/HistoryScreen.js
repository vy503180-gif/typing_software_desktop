...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: 'Poppins_700Bold', fontWeight: '700', color: COLORS.textWhite, fontSize: scaleFont(22) },
  ...
  summaryCard: { flex: 1, minWidth: 0, borderRadius: scaleSize(12), padding: scaleSize(10), alignItems: 'center', borderWidth: 1, overflow: 'hidden' },
  summaryVal: { fontSize: scaleFont(20), fontFamily: 'Poppins_700Bold', fontWeight: '700', flexShrink: 1, textAlign: 'center' },
  summaryLabel: { fontSize: scaleFont(10), color: COLORS.textMuted, fontFamily: 'Poppins_700Bold', fontWeight: '700', marginTop: scaleSize(2), flexShrink: 1, textAlign: 'center' },
  ...
  dayMsgText: { flex: 1, color: COLORS.amber, fontSize: scaleFont(12), lineHeight: scaleSize(18), fontFamily: 'Poppins_700Bold', fontWeight: '700'},
  ...
  emptyTitle: { color: COLORS.textWhite, fontSize: scaleFont(16), fontFamily: 'Poppins_700Bold', fontWeight: '700', marginTop: scaleSize(10) },
  emptyText: { fontFamily: 'Poppins_400Regular', color: COLORS.textMuted, fontSize: scaleFont(12), textAlign: 'center', marginTop: scaleSize(4), lineHeight: scaleSize(18) },
  ...
  rowLesson: { color: COLORS.textWhite, fontSize: scaleFont(13), fontFamily: 'Poppins_700Bold', fontWeight: '700'},
  rowMeta: { fontFamily: 'Poppins_400Regular', color: COLORS.textDim, fontSize: scaleFont(10), marginTop: 2 },
  ...
  rowWpm: { fontSize: scaleFont(14), fontFamily: 'Poppins_700Bold', fontWeight: '700'},
  rowUnit: { fontSize: scaleFont(9), fontFamily: 'Poppins_700Bold', fontWeight: '700'},
  accBadge: { borderRadius: scaleSize(6), paddingHorizontal: scaleSize(6), paddingVertical: scaleSize(3) },
  rowAcc: { fontSize: scaleFont(12), fontFamily: 'Poppins_700Bold', fontWeight: '700'},
});
